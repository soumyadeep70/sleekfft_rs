use std::arch::x86_64::{
    _mm256_add_pd as add_f64x4, _mm256_broadcast_sd as broadcast_f64,
    ...
    unsafe fn fwd_transform(&self, wr: &Vec<f64>, wi: &Vec<f64>, sr: &mut Vec<f64>, si: &mut Vec<f64>, k: usize) {
        ...
        while v >= 4 {
            ...
            for h in 1..u {
                ...
                let (w3r, w3i) = (
                    sub_f64x4(mul_f64x4(w1r, w2r), mul_f64x4(w1i, w2i)),
                    add_f64x4(mul_f64x4(w1r, w2i), mul_f64x4(w1i, w2r)),
                );
                ...
                for _ in (0..v).step_by(4) {
                    ...
                    let (x0r, x0i) = (t0r, t0i);
                    let (x1r, x1i) = (
                        sub_f64x4(mul_f64x4(t1r, w1r), mul_f64x4(t1i, w1i)),
                        add_f64x4(mul_f64x4(t1r, w1i), mul_f64x4(t1i, w1r)),
                    );
                    let (x2r, x2i) = (
                        sub_f64x4(mul_f64x4(t2r, w2r), mul_f64x4(t2i, w2i)),
                        add_f64x4(mul_f64x4(t2r, w2i), mul_f64x4(t2i, w2r)),
                    );
                    let (x3r, x3i) = (
                        sub_f64x4(mul_f64x4(t3r, w3r), mul_f64x4(t3i, w3i)),
                        add_f64x4(mul_f64x4(t3r, w3i), mul_f64x4(t3i, w3r)),
                    );
        ...
        while u > 0 {
            ...
            for h in 1..u {
                ...
                for _ in (0..v).step_by(4) {
                    ...
                    storeu_f64x4(p1r, sub_f64x4(mul_f64x4(y1r, w1r), mul_f64x4(y1i, w1i)));
                    storeu_f64x4(p1i, add_f64x4(mul_f64x4(y1r, w1i), mul_f64x4(y1i, w1r)));
                    storeu_f64x4(p2r, sub_f64x4(mul_f64x4(y2r, w2r), mul_f64x4(y2i, w2i)));
                    storeu_f64x4(p2i, add_f64x4(mul_f64x4(y2r, w2i), mul_f64x4(y2i, w2r)));
                    storeu_f64x4(p3r, sub_f64x4(mul_f64x4(y3r, w3r), mul_f64x4(y3i, w3i)));
                    storeu_f64x4(p3i, add_f64x4(mul_f64x4(y3r, w3i), mul_f64x4(y3i, w3r)));
